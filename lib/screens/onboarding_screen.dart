    ...
    return IntroductionScreen(
      ...
      pages: [
        ...
        PageViewModel(
          ...
          body: "매일 새로운 시작, 간단하게 관리하세요\n복잡한 일정 관리는 그만! 하루에 집중할 수 있는 할 일만 선택하세요",
          image: _buildPageImage(Icons.auto_awesome, AppColors.priorityHigh),
        ...
        PageViewModel(
          ...
          image: _buildPageImage(Icons.priority_high, AppColors.priorityMedium),
          decoration: _getPageDecoration(),
        ),
        ...
        PageViewModel(
          ...
          body: "당신의 성장을 시각화하세요\n완료한 할 일들을 달력에서 확인하고\n꾸준한 성취감을 느껴보세요",
          image: _buildPageImage(Icons.calendar_month, AppColors.priorityLow),
          decoration: _getPageDecoration(),
        ),
